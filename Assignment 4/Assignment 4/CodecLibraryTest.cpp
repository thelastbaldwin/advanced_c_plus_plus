...
TEST(brightnessDecoratorIterator, CodecLibrary)
{
    ...
    std::ofstream outFile(PROJECT_PATH + "output_basicBrightnessAdjusted.bmp", std::ios::binary);
    encoder->encodeToStream(outFile);
...
TEST(colorInvertDecoratorIterator, CodecLibrary)
{
    ...
    std::ofstream outFile(PROJECT_PATH + "output_basicColorInvert.bmp", std::ios::binary);
    encoder->encodeToStream(outFile);
...
TEST(doubleDecorator, CodecLibrary)
{
    ...
    std::ofstream outFile(PROJECT_PATH + "output_darkInverted.bmp", std::ios::binary);
    encoder->encodeToStream(outFile);
