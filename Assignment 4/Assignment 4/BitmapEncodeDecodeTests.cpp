...
{
    std::ifstream bitmapStream(PROJECT_PATH + "basic_101.bmp", std::ios::binary);
    CHECK(bitmapStream.is_open());
...
TEST(BitmapReadWrite_101, Bitmap)
{
    ...
    std::ofstream outputStream(PROJECT_PATH + "output_101.bmp", std::ios::binary);
    CHECK(outputStream.is_open());
    ...
    std::ifstream bitmapStream2(PROJECT_PATH +"output_101.bmp", std::ios::binary);
    CHECK(bitmapStream2.is_open());
